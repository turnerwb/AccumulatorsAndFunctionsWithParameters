...
def draw_circles1():
    ...
    for k in range(21):
        centre = rg.Point(200, 200)
        circle = rg.Circle(centre, k*10)
        circle.attach_to(window)
    window.render()  # To cause to render each circle individually, you should move this into loop and add a delay
...
def draw_circles2():
    ...
    window = rg.RoseWindow(400, 400)
    for k in range(18):
        centre = rg.Point(50+k*20, 100)
        circle = rg.Circle(centre, 10)
...
def draw_circles3():
    ...
    for k in range(100):
        centre = rg.Point(200, 150)
        circle = rg.Circle(centre, k+1)
        circle.attach_to(window)
    window.render()  # To cause to render each circle individually, you should move this into loop and add a delay
...
def draw_cosines_and_sines():
    ...
    window = rg.RoseWindow(400, 400)
    for k in range(101):
        centre = rg.Point(200 + (80 * math.cos(k)), 200 + (80 * math.sin(k)))
        circle = rg.Circle(centre, 10)
        circle.attach_to(window)
    window.render()  # To cause to render each circle individually, you should move this into loop and add a delay
