...
def run_test_sum_of_digits():
    ...
    # Test 2
    expected = 26
    answer = sum_of_digits(5678)
    print("Test 2 expected:", expected)
    print("       actual:  ", answer)

    # Test 3
    expected = 30
    answer = sum_of_digits(-452199)
...
def run_test_digits_in_power():
    ...
    # Test 2
    expected = 1
    answer = digits_in_power(2578, 0)
    print("Test 2 expected:", expected)
    print("       actual:  ", answer)

    # Test 3
    expected = 0
    answer = digits_in_power(0, 17234)
    print("Test 3 expected:", expected)
    print("       actual:  ", answer)
